...
SELECT id, '2024-ALICE', 17500.00 FROM users WHERE username = 'alice';
INSERT INTO accounts (user_id, account_number, balance)
SELECT id, '2024-BOB', 11200.50 FROM users WHERE username = 'bob';
INSERT INTO accounts (user_id, account_number, balance)
SELECT id, '2024-CHARLIE', 35000.00 FROM users WHERE username = 'charlie';
INSERT INTO accounts (user_id, account_number, balance)
SELECT id, '2024-ADMIN', 1000000.00 FROM users WHERE username = 'admin';
...
FROM accounts a1 JOIN accounts a2 ON a2.account_number = '2024-BOB'
WHERE a1.account_number = '2024-ALICE';

INSERT INTO transactions (from_account, to_account, amount, description, transaction_type)
SELECT a1.id, a2.id, 200.00, 'Coffee repayment', 'transfer'
FROM accounts a1 JOIN accounts a2 ON a2.account_number = '2024-CHARLIE'
WHERE a1.account_number = '2024-BOB';

INSERT INTO transactions (from_account, to_account, amount, description, transaction_type)
SELECT a1.id, a2.id, 1500.00, 'Project reimbursement', 'transfer'
FROM accounts a1 JOIN accounts a2 ON a2.account_number = '2024-ALICE'
WHERE a1.account_number = '2024-CHARLIE';
